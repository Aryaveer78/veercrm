...
//
// Why the `VEERCRM_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a VEERCRM key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `VEERCRM_test_` variant if
...
export const API_KEY_PREFIX = 'VEERCRM_live_';
