...
//
// Every delivery carries an `X-VEERCRM-Signature` header so receivers
// can verify the request really came from VEERCRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-VEERCRM-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-VEERCRM-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a VEERCRM-to-VEERCRM integration
