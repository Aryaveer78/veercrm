...
export interface Conversation {
   ...
   *  - `ai_reply_count` — how many bot auto-replies this thread has had
   *    (stats / handoff context; no longer gates the bot — it answers
   *    every inbound on an unassigned thread).
