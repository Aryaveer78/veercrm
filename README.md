# VEERCRM — CRM Template for WhatsApp
...
<p align="center">
  <a href="https://www.hostinger.com/web-apps-hosting?REFERRALCODE=VEERCRMHOST">
...
[![CI](https://github.com/ArnasDon/VEERCRM/actions/workflows/ci.yml/badge.svg)](https://github.com/ArnasDon/VEERCRM/actions/workflows/ci.yml)
[![Next.js 16](https://img.shields.io/badge/Next.js-16-black?logo=nextdotjs)](https://nextjs.org)
[![Supabase](https://img.shields.io/badge/Supabase-Postgres%20%2B%20Auth-3ecf8e?logo=supabase)](https://supabase.com)
[![Stars](https://img.shields.io/github/stars/ArnasDon/VEERCRM?style=social)](https://github.com/ArnasDon/VEERCRM/stargazers)

The marketing site and self-host docs live in a separate repo:
[ArnasDon/VEERCRM-site](https://github.com/ArnasDon/VEERCRM-site)
([VEERCRM.tech](https://VEERCRM.tech)). This repo is the product —
...
- **Full customisation** — add the fields your team needs, remove the
  ...
  short.
- **Zero ops to start** — [Hostinger](https://www.hostinger.com/web-apps-hosting?REFERRALCODE=VEERCRMHOST)
...
```bash
# Fork on GitHub first: https://github.com/ArnasDon/VEERCRM → Fork
git clone https://github.com/<your-username>/VEERCRM.git
cd VEERCRM
npm install
...
<p align="center">
  <a href="https://VEERCRM.tech/docs/deployment-hostinger">
    <img src="https://img.shields.io/badge/Step--by--step_guide-VEERCRM.tech%2Fdocs-111?style=for-the-badge" alt="Step-by-step guide" height="44">
  </a>
</p>

**VEERCRM is built to run on [Hostinger](https://www.hostinger.com/web-apps-hosting?REFERRALCODE=VEERCRMHOST).**
...
| **Managed Node.js** | Next.js 16 (App Router, server actions, ISR) runs out of the box on [Premium, Business, and Cloud](https://www.hostinger.com/web-apps-hosting?REFERRALCODE=VEERCRMHOST) shared plans. You don't manage Node versions, processes, or reverse proxies. |
...
**[VEERCRM.tech/docs/deployment-hostinger](https://VEERCRM.tech/docs/deployment-hostinger)**.

> _Note: VEERCRM is MIT-licensed and runs anywhere Node.js does
...
**[VEERCRM.tech/docs](https://VEERCRM.tech/docs)**
(source: [ArnasDon/VEERCRM-site](https://github.com/ArnasDon/VEERCRM-site)).

Key pages:
- [Getting started](https://VEERCRM.tech/docs/getting-started)
- [Supabase setup](https://VEERCRM.tech/docs/supabase-setup)
- [WhatsApp setup](https://VEERCRM.tech/docs/whatsapp-setup)
- [Environment variables](https://VEERCRM.tech/docs/environment-variables)
- [Deploy on Hostinger](https://VEERCRM.tech/docs/deployment-hostinger)
- [Architecture](https://VEERCRM.tech/docs/architecture)
- [Troubleshooting](https://VEERCRM.tech/docs/troubleshooting)
