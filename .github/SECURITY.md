...
- [GitHub Security Advisories](https://github.com/ArnasDon/VEERCRM/security/advisories/new)
...
In scope:
- Anything in this repository (`ArnasDon/VEERCRM`), including webhook and auth
