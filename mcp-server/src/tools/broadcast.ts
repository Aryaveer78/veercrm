...
//
// Registered only when BOTH VEERCRM_ENABLE_WRITES and
// VEERCRM_ENABLE_BROADCASTS are set. A single call can message up to
...
export function registerBroadcastTools(server: McpServer, client: VEERCRMClient): void {
  server.registerTool(
    'send_broadcast',
    {
